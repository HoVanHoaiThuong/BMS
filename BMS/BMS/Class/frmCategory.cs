    ...
    public partial class frmCategory : MetroFramework.Forms.MetroForm
    {
        ...
        private void btSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MetroMessageBox.Show(this, "The vaue cannot be empty or invalid!", "Message", MessageBoxButtons.OK, MessageBoxIcon.Hand);
                    return;
                }
        ...
        private void txtCategorySearch_ButtonClick(object sender, EventArgs e)
        {
            DataTable dt = CategoriesBUS.Instance.SearchCategoryByName(txtCategorySearch.Text);
            ListCategory.DataSource = dt;
