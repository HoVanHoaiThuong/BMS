...
namespace BMS.Class
{
    public partial class pnLogin : pnSlider
    {
        ...
        private void btLogin_Click(object sender, EventArgs e)
        {
            ...
            {
                MetroMessageBox.Show(this, "Username or password cannot be empty or invalid!", "Message", MessageBoxButtons.OK, MessageBoxIcon.Hand);
                return;
            }
        ...
        private void btConnect_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (dbName != "")
                {
                    ...
                    {
                        if (string.IsNullOrWhiteSpace(txtDbUserName.Text) || (string.IsNullOrWhiteSpace(txtDbUserName.Text)))
                        {
                            MetroMessageBox.Show(this, "Username/Password cannot be empty!", "Message", MessageBoxButtons.OK, MessageBoxIcon.Hand);
                            return;
                        }
