...
namespace BMS.Class
{
    public partial class frmEmployee : pnSlider
    {
        ...
        private void btSave_Click(object sender, EventArgs e)
        {
            try
            {
                if (string.IsNullOrWhiteSpace(txtUserName.Text) || string.IsNullOrWhiteSpace(txtPassword.Text) || string.IsNullOrWhiteSpace(txtFirstName.Text) || string.IsNullOrWhiteSpace(txtLastName.Text) || string.IsNullOrWhiteSpace(txtPhone.Text) || string.IsNullOrWhiteSpace(txtAddress.Text) || string.IsNullOrWhiteSpace(txtIDNo.Text))
                {
        ...
        {
            uint x;
            if (uint.TryParse(txtIDNo.Text, out x) && txtIDNo.Text.Length > 8)
            {
        ...
        {
            long x;
            if (long.TryParse(txtPhone.Text, out x) && txtPhone.Text.Length > 9 && txtPhone.Text.Length < 13)
            {
